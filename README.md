...
- examples/diverge-converge-pipeline.md (full pipeline)
- examples/brainstorm-solo.md (standalone ideation session)
- examples/quick-decision.md (fast debate on known options)
